      ...
      {Object.keys(formErrors).length === 0 && isSubmit && (
        ...
        >
          ...
          <Modal.Content style={{textAlign: 'center'}}>
            <p>
              You will receive an email with an account confirmation link within the next few minutes. If you did not receive an email, check your <b>Spam Folder</b> and mark it as 'Not Spam' for the future!
            </p>
          </Modal.Content>
